...
const displayTooSoon = () => {
  clickableArea.style.backgroundColor = "#ff4646";
  message.innerHTML = "You are reacting too fast. Please wait for the GREEN color and click again to continue.";
  
  message.style.color = "#000000";
  clickableArea.style.padding = "250px";
  message.style.fontWeight ="500px";
